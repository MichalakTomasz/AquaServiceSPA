...
namespace AquaServiceSPA.Models
{
    public class ExpressResult
    {
        ...
        public double? MaxConcentrationNinKNO3MgPerLiter { get; set; }
        ...
        public double? OptimalConcentrationKinK2SO4MgPerLiter { get; set; }

        public double? MaxMgSO4g { get; set; }
        public double? MaxConcentrationMginMgSO4MgPerLiter { get; set; }
        public double? OptimalMgSO4g { get; set; }
        public double? OptimalConcentrationMginMgSO4MgPerLiter { get; set; }
    }
}
